            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">@lang('lang.confirm_password')</label>
                        ...
                        <div class="row mb-3">
                            <label for="occupation_id" class="col-md-4 col-form-label text-md-end">@lang('lang.occupation')</label>
                        ...
                        <div class="row mb-3">
                            <label for="linkedin_username" class="col-md-4 col-form-label text-md-end">@lang('lang.linkedin')</label>
                        ...
                        <div class="row mb-3">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end">@lang('lang.phone')</label>
                        ...
                        <div class="row mb-3">
                            <label for="experience_years" class="col-md-4 col-form-label text-md-end">@lang('lang.experience')</label>
                        ...
                        <div class="row mb-3">
                            <label for="price" class="col-md-4 col-form-label text-md-end">@lang('lang.registration_price')</label>
